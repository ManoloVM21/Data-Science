...
1. Install Python dependencies (example):
   ...
   ```
2. Render Quarto documents (if you use Quarto):
   ```bash
   quarto render
   ```
...
If you’d like to discuss these projects or request additional modeling/deployment examples (classification/regression, pipelines, evaluation, MLOps), feel free to reach out via GitHub: **@ManoloVM21**
